...
<?php $__env->startSection('title', 'Add New User Target'); ?>
...
<form action="<?php echo e(route('user_targets.store')); ?>" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="target_amount"  class="form-control" placeholder="Amount" required="required" />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\angel1\resources\views/user_targets/create.blade.php ENDPATH**/ ?>